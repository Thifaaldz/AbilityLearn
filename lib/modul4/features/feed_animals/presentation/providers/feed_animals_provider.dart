...
class FeedAnimalsProvider extends ChangeNotifier {
  ...
  List<FoodItem> _items = [
    FoodItem(id: '1', name: 'Susu', imageAsset: 'assets/images/modul4/cat_milk_new.png', type: FoodType.drink),
    FoodItem(id: '2', name: 'Makanan', imageAsset: 'assets/images/modul4/cat_food_new.png', type: FoodType.food),
  ];
