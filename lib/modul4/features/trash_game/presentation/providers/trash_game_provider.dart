...
class TrashGameProvider extends ChangeNotifier {
  ...
  List<TrashItem> _items = [
    const TrashItem(
      id: '1',
      name: 'Apel',
      imageAsset: 'assets/images/modul4/trash_item_apple_new.png', 
      type: TrashType.organic,
    ),
    const TrashItem(
      id: '2',
      name: 'Kaleng',
      imageAsset: 'assets/images/modul4/trash_item_can_new.png',
      type: TrashType.inorganic,
    ),
    const TrashItem(
      id: '3',
      name: 'Botol',
      imageAsset: 'assets/images/modul4/trash_item_bottle_new.png',
      type: TrashType.inorganic,
    ),
  ];
